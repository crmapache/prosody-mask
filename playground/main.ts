import { createMask, defaultStyle, type MaskHandle, type MaskInput, type MaskStyle } from 'prosody-mask'
...
// the preset. It scales the demo passage; the mask re-measures on redraw.
